...
* The original package name 'com.nasa-space-app.sdgs-web-app.lesson-planner' is invalid and this project uses 'com.nasa_space_app.sdgs_web_app.lesson_planner' instead.
